        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-5 gap-8">
              <div>
                <h3 className="text-base font-bold text-slate-800">Company Info</h3>
              ...
              <div>
                <h3 className="text-base font-bold text-slate-800">Legal</h3>
                <ul className="mt-4 space-y-2">
                  <li>
                    <a
                      href="#"
              ...
              <div>
                <h3 className="text-base font-bold text-slate-800">Features</h3>
                <ul className="mt-4 space-y-2">
                  <li>
                    <a
                      href="#"
                ...
                <form className="mt-4">
                  <div className="flex">
                    <input
                      ...
                      className="flex-1 px-4 py-2 text-sm text-neutral-500 bg-stone-50 border border-neutral-200 rounded-l-md focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent"
                      required
                    />
                    <button
                      type="submit"
                      className="px-6 py-2 text-sm font-bold text-white bg-sky-500 hover:bg-sky-600 rounded-r-md transition-colors"
                    >
                      Subscribe
                    </button>
                  </div>
